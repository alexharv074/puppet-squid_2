class squid::config (
  ...
  $acls                          = $::squid::acls,
  $append_domain                 = $::squid::append_domain,
  $auth_params                   = $::squid::auth_params,
  $cache                         = $::squid::cache,
  $cache_dirs                    = $::squid::cache_dirs,
  $cache_effective_group         = $::squid::cache_effective_group,
  $cache_effective_user          = $::squid::cache_effective_user,
  $cache_log                     = $::squid::cache_log,
  $cache_mem                     = $::squid::cache_mem,
  $cache_mgr                     = $::squid::cache_mgr,
